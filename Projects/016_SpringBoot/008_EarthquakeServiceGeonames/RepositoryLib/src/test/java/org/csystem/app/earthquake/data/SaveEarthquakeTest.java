...
public class SaveEarthquakeTest {
    ...
    @Test
    @Order(0)
    public void givenValue_whenEarthquake_thenPrivateSaveRegionInfo_generated_id_true() throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, SQLException
    {
        ...
        Method method = RegionInfoRepository.class.getDeclaredMethod("saveRegionInfo", RegionInfo.class);
